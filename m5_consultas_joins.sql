...
-- ===========================================
-- Consulta 4 - Consolidado por categoría
-- La base de datos creada no contiene online y presencial
-- entonces adapto la consulta a categorias. 
-- ===========================================
SELECT
    categoria,
...
FROM (
    ...
    INNER JOIN categorias c
        ON p.id_categoria = c.id_categoria
    WHERE c.nombre_categoria = 'Almacenamiento'
...
-- La base de datos creada en los módulos anteriores no incluye las tablas
-- territorios ni las columnas segmento, region y canal mencionadas en la
-- consigna. Por este motivo, las consultas fueron adaptadas a la 
-- base de datos disponible (clientes, productos, categorias y ventas).
